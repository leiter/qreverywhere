...
/**
 * Screen for creating QR codes with App Store links
 *
 * Supports:
 * - iOS App Store: https://apps.apple.com/app/id{appId}
        ...
        Button(
            onClick = {
                ...
                try {
                    ...
                    viewModel.saveQrItemFromText(storeUrl, AcquireType.CREATED)
