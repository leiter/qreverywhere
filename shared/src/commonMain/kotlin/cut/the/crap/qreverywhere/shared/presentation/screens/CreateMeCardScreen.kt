...
/**
 * Screen for creating MeCard QR codes (simpler alternative to vCard)
 * Output format: MECARD:N:Name;TEL:Phone;EMAIL:Email;;
 */
@Composable
        ...
        Button(
            onClick = {
                ...
                try {
                    ...
                    val meCardText = meCard.toMeCard()

                    // Create QR code using ViewModel
                    viewModel.saveQrItemFromText(meCardText, AcquireType.CREATED)
